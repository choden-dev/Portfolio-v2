    ...
    >
      <Box display="flex" marginTop="auto">
        <Box
          ...
          as={motion.div}
          onClick={() =>
            openInNewTab("https://www.linkedin.com/in/benson-cho-918996234")
          }
          whileHover={{ y: -2 }}
          height="2rem"
          width="2rem"
        ...
        <Box
          onClick={() => openInNewTab("https://github.io/choden-dev")}
          cursor="pointer"
          as={motion.div}
          whileHover={{ y: -2 }}
          height="2rem"
...
const desktopVersion = (
  <>
    ...
    >
      ...
      <Box
        onClick={() => openInNewTab("https://github.com/choden-dev")}
        cursor="pointer"
        as={motion.div}
        whileHover={{ y: -2 }}
        height="2rem"
